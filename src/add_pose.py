...
def add_pose(graph, initial_estimate):
    ...
    # CORERCTION: Add the odometry factor between X(3) and X(4) to the graph (BetweenFactorPose2)
    ...
    # CORRECTION: Based on the odometry, find the initial estimate for the pose of X(4) and add it to the graph
